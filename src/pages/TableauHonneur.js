...
export default function TableauHonneur({ navigate }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #0a0a0a 0%, #1a1a1a 50%, #0d2b1f 100%)', padding: '2rem 1.5rem' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
        <button onClick={() => navigate('dashboard')} style={{ background: 'rgba(255,255,255,0.1)', border: '0.5px solid rgba(255,255,255,0.2)', color: '#fff', borderRadius: 8, padding: '6px 14px', fontSize: 12, cursor: 'pointer', marginBottom: '1.5rem' }}>← Retour</button>

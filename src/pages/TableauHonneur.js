          ...
          {elevesClasses.length > 0 && (
            <div style={{display:'flex',gap:6,flexShrink:0}}>
              <button onClick={handleExportPDF}
                style={{background:'rgba(226,75,74,0.2)',border:'1px solid rgba(226,75,74,0.4)',borderRadius:10,padding:'7px 11px',color:'#FCA5A4',fontSize:12,fontWeight:700,cursor:'pointer',fontFamily:'inherit',whiteSpace:'nowrap'}}>
                📄 PDF
              </button>
              <button onClick={handleExportExcel}
                style={{background:'rgba(29,158,117,0.2)',border:'1px solid rgba(29,158,117,0.4)',borderRadius:10,padding:'7px 11px',color:'#5DCAA5',fontSize:12,fontWeight:700,cursor:'pointer',fontFamily:'inherit',whiteSpace:'nowrap'}}>
                📊 Excel
              </button>
            </div>
          )}
